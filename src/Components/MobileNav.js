...
function MobileNav({ items, setMobileNav }) {
  return (
    <ul className="block md:hidden fixed bg-very-dark-blue bg-opacity-95 w-full h-full py-9 px-8 z-20">
      <div className="flex justify-between self-start items-center h-auto  w-full">
      ...
      <div className="flex flex-col justify-between h-full">
        <ul className="flex flex-col mt-10 text-center">
          ...
          <li className="text-white border-t-2 border-grayish-blue border-opacity-20 py-5">
            <button className="border-2 border-white w-full py-3 text-xl tracking-widest rounded-md">
              LOGIN
            </button>
          </li>
        </ul>
